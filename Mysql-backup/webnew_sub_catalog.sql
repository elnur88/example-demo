...
CREATE TABLE `sub_catalog` (
  ...
  `catalog_oid` varchar(50) NOT NULL,
...
LOCK TABLES `sub_catalog` WRITE;
/*!40000 ALTER TABLE `sub_catalog` DISABLE KEYS */;
/*!40000 ALTER TABLE `sub_catalog` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-08-27  9:20:08
